...
class mmInterface {
    ...
    static getLeaderboard(type, stat) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (type) {
                case "playtime":
                    return yield mmLeaderboard_1.default.playtime(stat);
                case "mobkills":
                    return yield mmLeaderboard_1.default.mobKills(stat);
                case "playerkills":
                    return yield mmLeaderboard_1.default.playerKills(stat);
                default:
                    return null;
            }
        });
