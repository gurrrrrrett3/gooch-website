...
class mmLeaderboard {
    static playtime(stat) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            data.data.forEach((player) => __awaiter(this, void 0, void 0, function* () {
                ...
                const playerData = mmInterface_1.default.getPlayer(playername);
                let f_playtime = "";
                switch (stat) {
                    case "total":
                ...
                out.push({
                    name: playername,
                    playtime: mmInterface_1.default.formatPlanDate(f_playtime),
                    f_playtime,
                });
            }));
            out.sort((a, b) => {
    ...
    static playerKills(stat) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = mmInterface_1.default.getPlayers();
            let out = [];
            data.data.forEach((player) => __awaiter(this, void 0, void 0, function* () {
                const playername = (0, node_html_parser_1.default)(player.name).childNodes[0].rawText;
                const playerData = mmInterface_1.default.getPlayer(playername);
