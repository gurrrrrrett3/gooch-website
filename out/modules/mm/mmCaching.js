...
class mmCaching {
    ...
    cachePlayers() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < queue.length; i++) {
                ...
                yield mmInterface_1.default.fetchPlayer(username).then((playerData) => {
    ...
    saveCache(data, file) {
        fs_1.default.writeFileSync(path_1.default.resolve(`./data/mm/cache/${file}.json`), JSON.stringify(data));
    }
    loadCache(file) {
    ...
    saveCachedPlayer(username, data) {
        fs_1.default.writeFileSync(path_1.default.resolve(`./data/mm/cache/players/${username}.json`), JSON.stringify(data));
    }
    loadCachedPlayer(username) {
        return JSON.parse(fs_1.default.readFileSync(path_1.default.resolve(`./data/mm/cache/players/${username}.json`), "utf8"));
    }
    getCacheData() {
        return JSON.parse(fs_1.default.readFileSync(path_1.default.resolve(`./data/mm/cache/data.json`), "utf8"));
    }
    saveCacheData(data) {
        fs_1.default.writeFileSync(path_1.default.resolve(`./data/mm/cache/data.json`), JSON.stringify(data));
    }
    checkForCacheData() {
        if (!fs_1.default.existsSync(path_1.default.resolve(`./data/mm/cache/data.json`))) {
            this.saveCacheData({
                timestamp: Date.now(),
                report: {
                    players: 0,
    ...
    checkForCacheFiles() {
        if (!fs_1.default.existsSync(path_1.default.resolve(`./data/mm/cache/players`))) {
            fs_1.default.mkdirSync(path_1.default.resolve(`./data/mm/cache/players`), { recursive: true });
        }
    }
}
